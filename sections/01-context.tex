  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.35\textwidth}
      ...
      \begin{itemize}
        ...
        \item Significant pluvial, and river-flooding, damages
      \end{itemize}
    \end{column}
    \hspace{0.1cm}
...
\begin{frame}{The hazard we model is not river flooding}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{itemize}
        \item Pluvial risk depends on local rainfall, drainage and
          the building envelope
        \item River-flood risk depends on upstream flow, channel
          capacity and floodplain exposure
      \end{itemize}
    \end{column}
  \end{columns}
