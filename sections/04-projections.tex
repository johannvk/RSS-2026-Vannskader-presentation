...
\begin{frame}{Change the climate, hold building portfolio fixed}
  ...
  \begin{tikzpicture}[
      period/.style={draw=accent1,thick,rounded corners=2pt,fill=softgrey,
      minimum width=3.6cm,minimum height=1.65cm,text width=3.2cm,align=center},
      future/.style={draw=riskred,thick,rounded corners=2pt,fill=white,
      minimum width=4.0cm,minimum height=1.65cm,text width=3.6cm,align=center},
      arrow/.style={-{Latex[length=3mm]},thick,color=accent1}
    ]
    \node[period] (base) at (-3.4,0)
    {\textbf{Reference}\\1991--2020\\[-0.02cm]
    {\scriptsize Using 2026 NOK}};
    \node[future] (mid) at (2.2,1.35)
    {\textbf{Mid-century}\\2041--2070\\[-0.02cm]
    {\scriptsize RCP2.6 \enspace RCP4.5 \enspace SSP3-7.0}};
    \node[future] (late) at (2.2,-1.35)
    {\textbf{Late century}\\2071--2100\\[-0.02cm]
    {\scriptsize RCP2.6 \enspace RCP4.5 \enspace SSP3-7.0}};
    \draw[arrow] (base.east) -- (mid.west);
    \draw[arrow] (base.east) -- (late.west);
  \end{tikzpicture}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item High-emissions county medians:
          ...
          \end{itemize}
        \item Largest increase in Finnmark, and southern mountain regions
        \item Lower increase in Western Norway
      \end{itemize}
    \end{column}
