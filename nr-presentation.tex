...
% Lift footnotes off the bottom edge of the slide: the footline is
% typeset below the footnote block, so adding space there raises it.
\addtobeamertemplate{footline}{}{\vspace{1.2em}}
