...
% Title Slide
{
  ...
  \begin{frame}
    \vspace{2cm}
    \Large \textbf {Tittel her} \\
    \vspace{1cm}
    \normalsize Forfatter X, Norsk Regnesentral\\
    \vspace{2cm}
    \small dato her
  \end{frame}
}
...
\begin{frame}{Tittel lysbilde  med tekst}
  \begin{itemize}
  \item Tekst nivå 1
    \begin{itemize}
    \item Tekst nivå 2
...
\begin{frame}{Tittel lysbilde med tekst og formel}
  \begin{itemize}
  \item Tekst nivå 1
  \end{itemize}
  \begin{align*} 
...
\begin{frame}{Figur yyy}
  \begin{flushleft}
    \raisebox{0pt}[0pt][0pt]{\makebox[0pt][c]{\raisebox{-25ex}{
          \makebox[\linewidth]{\includegraphics[type=pdf,ext=.pdf,read=.pdf,
...
% Final slide
\usebackgroundtemplate{\includegraphics[width=1\paperwidth]{backgrounds/nr3.pdf}}
\begin{frame}{Takk for oppmerksomheten!}
  \begin{center}
